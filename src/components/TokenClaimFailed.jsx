...
export default class TCFMain extends React.Component {
	render() {
		return (
			<main>
				<div className="container">

					<h1 className="p-4 m-4 text-center"><i class="text-danger fa fa-fw fa-times-circle"/> Failed to Credit Token</h1>
